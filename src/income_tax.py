...
Please call get_additional_parameters() to find available timeframes and format"
        ...
        try:
            ...
            personal_allowance_threshold = financial_year_data[
                "personal_allowance threshold"
            ]
            if (
                personal_allowance_threshold + thresholds[1] * 2
                > current_salary
                > personal_allowance_threshold
            ):
                deduction_from_allowance = (
                    current_salary - personal_allowance_threshold
                ) // 2
            ...
            return {
                "Annual breakdown": {
                    ...
                    "breakdown": {
                        key: format(value, ".2f") for key, value in breakdown.items()
                    },
