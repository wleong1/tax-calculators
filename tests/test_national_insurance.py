...
def test_Calculate_constant_year_over_first_threshold():
    test_national_insurance = national_insurance.NationalInsurance(29000)
    financial_year = "2018-19"
    calculated_partial_results = {'gross income': '29000.00', 'breakdown': {0: 0, 0.12: 2469.12, 0.02: 0}, 'total NI': '2469.12'}
    results = test_national_insurance.Calculate(financial_year=financial_year)
...
def test_Calculate_constant_year_over_second_threshold():
    ...
    financial_year = "2018-19"
    calculated_partial_results = {'gross income': '100000.00', 'breakdown': {0: 0, 0.12: 4555.2, 0.02: 1072.32}, 'total NI': '5627.52'}
    results = test_national_insurance.Calculate(financial_year=financial_year)
...
def test_Calculate_variable_year_over_first_threshold():
    ...
    test_national_insurance = national_insurance.NationalInsurance(29000)
    financial_year = "2022-23"
    calculated_partial_results = {'gross income': '29000.00', 'breakdown': {0: 0, 0.12: 2469.12, 0.02: 0}, 'total NI': '2180.08'}
    results = test_national_insurance.Calculate(financial_year=financial_year)
